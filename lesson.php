...
<body>
    <div class="container">
        ...
        <div class="row article-grid">
            ...
            <div class="col-md-4">
                <div class="card article-card">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/MapofEelamTamilcountryengraving1692.jpg/472px-MapofEelamTamilcountryengraving1692.jpg" class="card-img-top" alt="Jaffna Kingdom Resistance">
                    <div class="card-body">
                        <h5 class="card-title"><b>Resistance from the Jaffna Kingdom</b></h5>
                        <p class="card-text">Discover the resistance faced by the Jaffna Kingdom against Portuguese colonization efforts.</p>
                        <a href="lesson.php" class="btn btn-primary">Read More</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card article-card">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/Peradeniya_Site_Sri_Lanka.jpg/800px-Peradeniya_Site_Sri_Lanka.jpg" class="card-img-top" alt="Peradeniya in the Kandy Kingdom">
                    <div class="card-body">
                        <h5 class="card-title"><b>Kandy Kingdom: Last Stand Against the Portuguese</b></h5>
                        <p class="card-text">Learn about the final resistance of the Kandy Kingdom against Portuguese forces.</p>
                        <a href="lesson.php" class="btn btn-primary">Read More</a>
                    </div>
                </div>
            </div>
